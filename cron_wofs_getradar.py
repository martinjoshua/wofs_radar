...
_prep_nexrad_string  = "/work/wicker/REALTIME/WOFS_radar/prep_nexrad.py --newse %s --noanal --start %s --end %s -d %s" 
...
def scheduled_job():
    ...
    # MRMS processing
    cmd = (_prep_nexrad_string % (radar_file_csh,cycle_time_str, cycle_time_str2, _NEXRAD_dir))
    print("\n Cmd: %s \n" % (cmd))
